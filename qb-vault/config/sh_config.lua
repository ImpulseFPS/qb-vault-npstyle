...
Config.StorageDefaultWeight=400000
Config.StorageAddStep=200000
Config.StorageAddPrice=3000
...
Config.location = {
    ...
    [2] = {name="Only_ForTreyy" , coords= vector3(-45.52, -1275.12, 29.22),heading=270.41,minz=27.36 , maxz=30.87834,length=1,width=3,distance=2.5,debug=false},
}